...
class Boards(models.Model):
    ...
    author = models.ForeignKey("user.User", on_delete=models.CASCADE, related_name='author_board')
...
class Tasks(models.Model):
    ...
    status = models.ForeignKey(Columns, on_delete=models.CASCADE, related_name='task') # shuyerga default brnchi obj ni oladgon method yozish kk
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    deadline = models.DateField()
    assignee = models.ForeignKey("user.User", on_delete=models.CASCADE, related_name='task_assignee')
    developer = models.ForeignKey("user.User", on_delete=models.CASCADE, related_name='task_developer')
